...
class LastOnline extends StatelessWidget {
  LastOnline({Key? key}) : super(key: key);

  final lastOnlineList = OnlineChatsList.generateOnlineChats();
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.builder(
              ...
              itemCount: lastOnlineList.length
          ),
